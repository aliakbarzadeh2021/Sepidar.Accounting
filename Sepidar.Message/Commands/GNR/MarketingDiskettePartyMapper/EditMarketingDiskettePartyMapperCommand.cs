...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditMarketingDiskettePartyMapperCommand : ICommandBase
    {
        ...
        {
            new EditMarketingDiskettePartyMapperCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
