...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditMarketingDisketteItem1396Command : ICommandBase
    {
        ...
        {
            new EditMarketingDisketteItem1396CommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
