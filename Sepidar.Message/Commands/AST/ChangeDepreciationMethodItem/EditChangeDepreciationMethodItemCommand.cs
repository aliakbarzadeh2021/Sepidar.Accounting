...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditChangeDepreciationMethodItemCommand : ICommandBase
    {
        ...
        {
            new EditChangeDepreciationMethodItemCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
