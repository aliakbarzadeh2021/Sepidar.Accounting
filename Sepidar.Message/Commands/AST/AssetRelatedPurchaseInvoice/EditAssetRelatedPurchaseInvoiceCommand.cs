...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditAssetRelatedPurchaseInvoiceCommand : ICommandBase
    {
        ...
        {
            new EditAssetRelatedPurchaseInvoiceCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
