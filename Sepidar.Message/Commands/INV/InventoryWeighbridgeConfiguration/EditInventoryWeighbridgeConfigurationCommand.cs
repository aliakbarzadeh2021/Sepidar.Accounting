...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditInventoryWeighbridgeConfigurationCommand : ICommandBase
    {
        ...
        {
            new EditInventoryWeighbridgeConfigurationCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
