...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class AddInventoryPurchaseInvoiceItemCommand : ICommandBase
    {
        ...
        {
            new AddInventoryPurchaseInvoiceItemCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
