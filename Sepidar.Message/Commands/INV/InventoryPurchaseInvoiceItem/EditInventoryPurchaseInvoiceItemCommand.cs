...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditInventoryPurchaseInvoiceItemCommand : ICommandBase
    {
        ...
        {
            new EditInventoryPurchaseInvoiceItemCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
