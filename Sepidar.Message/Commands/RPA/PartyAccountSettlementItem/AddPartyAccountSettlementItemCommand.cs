...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class AddPartyAccountSettlementItemCommand : ICommandBase
    {
        ...
        {
            new AddPartyAccountSettlementItemCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
