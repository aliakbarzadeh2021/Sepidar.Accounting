...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditInvoiceItemAdditionFactorCommand : ICommandBase
    {
        ...
        {
            new EditInvoiceItemAdditionFactorCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
