...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditQuotationCommissionBrokerCommand : ICommandBase
    {
        ...
        {
            new EditQuotationCommissionBrokerCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
