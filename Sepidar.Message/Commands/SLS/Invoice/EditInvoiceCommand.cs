...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditInvoiceCommand : ICommandBase
    {
		...
		public Boolean ShouldControlCustomerCredit { get; set; }  
 
		public Nullable<Boolean> BaseOnInventoryDelivery { get; set; }  
        ...
        {
            new EditInvoiceCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
