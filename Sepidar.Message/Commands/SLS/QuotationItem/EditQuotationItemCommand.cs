...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditQuotationItemCommand : ICommandBase
    {
        public Guid Id {get;set;}
          
 
		public Int32 QuotationItemID { get; set; }  
		...
		public Nullable<Int32> DiscountQuotationItemRef { get; set; }  
        ...
        {
            new EditQuotationItemCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
