...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditReturnedInvoiceCommissionBrokerCommand : ICommandBase
    {
        ...
        {
            new EditReturnedInvoiceCommissionBrokerCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
