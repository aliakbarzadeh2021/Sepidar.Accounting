...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class AddReturnedInvoiceItemAdditionFactorCommand : ICommandBase
    {
        ...
        {
            new AddReturnedInvoiceItemAdditionFactorCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
