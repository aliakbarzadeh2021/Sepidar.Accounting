...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditCommissionCalculationInvoiceCommand : ICommandBase
    {
        ...
        {
            new EditCommissionCalculationInvoiceCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
