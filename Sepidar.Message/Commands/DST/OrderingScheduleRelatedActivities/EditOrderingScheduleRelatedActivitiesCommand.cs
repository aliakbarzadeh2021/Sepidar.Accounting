...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditOrderingScheduleRelatedActivitiesCommand : ICommandBase
    {
        ...
        {
            new EditOrderingScheduleRelatedActivitiesCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
