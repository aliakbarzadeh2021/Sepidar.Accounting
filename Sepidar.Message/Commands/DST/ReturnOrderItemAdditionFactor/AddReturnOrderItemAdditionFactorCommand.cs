...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class AddReturnOrderItemAdditionFactorCommand : ICommandBase
    {
        ...
        {
            new AddReturnOrderItemAdditionFactorCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
