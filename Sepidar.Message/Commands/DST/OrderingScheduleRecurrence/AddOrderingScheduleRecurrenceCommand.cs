...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class AddOrderingScheduleRecurrenceCommand : ICommandBase
    {
        ...
        {
            new AddOrderingScheduleRecurrenceCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
