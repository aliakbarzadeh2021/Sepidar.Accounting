...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class AddHotDistributionUnexecutedActCommand : ICommandBase
    {
        ...
        {
            new AddHotDistributionUnexecutedActCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
