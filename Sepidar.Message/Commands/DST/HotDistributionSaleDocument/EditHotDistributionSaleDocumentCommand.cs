...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class EditHotDistributionSaleDocumentCommand : ICommandBase
    {
        ...
        {
            new EditHotDistributionSaleDocumentCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
