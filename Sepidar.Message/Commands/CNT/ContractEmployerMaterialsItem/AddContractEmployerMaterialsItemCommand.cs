...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class AddContractEmployerMaterialsItemCommand : ICommandBase
    {
        ...
        {
            new AddContractEmployerMaterialsItemCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
