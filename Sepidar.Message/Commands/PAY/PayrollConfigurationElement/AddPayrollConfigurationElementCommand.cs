...
namespace Sepidar.Message.Commands
{
    ...
    ///  
    /// </summary>
    public class AddPayrollConfigurationElementCommand : ICommandBase
    {
        ...
        {
            new AddPayrollConfigurationElementCommandValidator().Validate(this).RaiseExceptionIfRequired();
        }
    }
}
